...
public class ShootingConsistencyTest extends LinearOpMode {
    ...
    public static double TESTING_SPEED = -0.83 * MOTOR_MAX_RPM;

    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(70, 0, 0, 13.6);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Servo servo = hardwareMap.get(Servo.class, "servo_thrower");
