...
class testVictor : BBLinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        val trajectory4 = robot.trajectoryBuilder(Pose2d(-19.5, -37.29, Math.toRadians(180.0)))
        ...
        wait(0.75)
        get<ServoThrowerModule>().close()
        val trajectory5 = robot.trajectoryBuilder(Pose2d(-1.5, -37.29, Math.toRadians(180.0)))
